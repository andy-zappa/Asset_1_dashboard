...
def generate_asset_data():
    ...
    # 🎯 삼성화재 퇴직연금 이율보증형(3년) 3.05% 일할 계산 로직
    now_date = datetime.now()
    # 기존 데이터 수익 319,114원 보정을 위해 2026.03.01을 기준점으로 잡고 매일 이자 가산
    ...
    dc_items = [
        ...
        {"종목명": "삼성화재 퇴직연금이율보증형(3년)", "코드": "-", "수량": "-", "매입가": "-", "현재가": "-", "전일비": 0, "총자산": samsung_asset, "매입금액": samsung_principal},
        {"종목명": "현금성자산", "코드": "-", "수량": "-", "매입가": "-", "현재가": "-", "전일비": 0, "총자산": 653113, "매입금액": 653113}
    ]

    # =====================================================================
    # 📝 [2] 연금저축 (CMA) - Andy님 지정 디폴트 순서 적용
    # =====================================================================
    pension_items = [
    ...
    def process_account(items, principal):
        ...
        processed.append({
            "종목명": "[ 합계 ]", "코드": "-", "비중": 100.0, "총 자산": sum_asset, "평가손익": sum_profit,
