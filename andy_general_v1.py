...
# =====================================================================
# 🔑 한국투자증권 Open API (가장 안정적인 공식 데이터망)
# =====================================================================
...
def generate_general_data():
    print("🔄 ZAPPA: 한국투자증권(KIS) API 통신을 시작합니다...")
    ...
    def process_and_update(items, is_usa=False):
        processed = []; sum_asset = 0; sum_profit = 0; sum_buy = 0
        for it in items:
            if it["종목명"] == "예수금":
                asset = it.get("예수금액", 0)
    ...
    final_data = {
        "DOM1": process_and_update(dom1), "DOM2": process_and_update(dom2),
