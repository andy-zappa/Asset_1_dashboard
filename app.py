...
css = [
    ...
    # [수정] 박스 테두리 둥글게(6px) + 박스와 박스 사이 2pt 간격 + 텍스트 줄바꿈 방지
    "div[data-testid='stHorizontalBlock'] { gap: 2pt !important; }",
    "div[data-testid='column'] { padding: 0 !important; }",
    "div.stButton>button { font-weight:normal!important; border-radius:6px!important; padding:0.3rem 0.5rem!important; width:100%!important; font-size:13px!important; margin:0!important; white-space:nowrap!important; border:1px solid #ccc!important; }",
...
# ==========================================
# [복원] 좌측 ZAPPA 엔진 로딩 (에러 방지 예외처리 포함)
# ==========================================
with st.sidebar:
...
# [수정] 박스 크기 및 비율 재조정 (2pt 간격을 고려하여 글씨가 밀리지 않게 여유 공간 부여)
