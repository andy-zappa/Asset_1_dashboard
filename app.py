...
# 11. 🤖 AI 퀀트매매 카드 (우측 정렬 및 오류 방지 완전판)
    quant_card_html = f"""
    <div id='card-quant' class='sidebar-card' style='display:flex; flex-direction:row; align-items:center; justify-content:flex-start; padding-left: 15px; gap:6px; height: 80px; margin-bottom: 5px; background-color:#ffffff; border:1px solid #eeeeee; border-radius:12px;'>
