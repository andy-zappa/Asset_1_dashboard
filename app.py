...
with st.sidebar:
    ...
    <div id='card-quant' class='sidebar-card' style='display:flex; flex-direction:row; align-items:center; justify-content:center; gap:12px; height: 80px; margin-bottom: 25px; background-color:#ffffff; border:1px solid #eeeeee; border-radius:12px;'>
        ...
        <div style='display:flex; flex-direction:column; align-items:flex-start; justify-content:center;'>
            <div style='font-size:24px; font-weight:700; color:#111111; letter-spacing:-1.5px; line-height:1.1;'>AI 퀀트매매</div>
            <div style='font-size:12px; color:#555; font-weight:500; letter-spacing:0px; margin-top:2px; margin-left: 1.5px;'>Built & Algo by Andy</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
# =========================================================
