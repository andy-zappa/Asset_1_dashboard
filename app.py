...
css = [
    ...
    # [핵심 수정 1] Streamlit 기본 갭(Gap) 강제 삭제 및 여백 0 처리하여 버튼을 바싹 붙임
    "div[data-testid='stHorizontalBlock'] { gap: 1px !important; }",
    "div[data-testid='column'] { padding: 0 !important; }",
    
    # [핵심 수정 2] 폰트 크기 13px로 고정, 박스 찌그러짐 방지(nowrap) 강제 적용
    "div.stButton>button { font-weight:normal!important; border-radius:4px; padding:0.2rem 0.2rem!important; width:100%!important; font-size:13px!important; margin:0!important; white-space:nowrap!important; }",
    "</style>"
]
