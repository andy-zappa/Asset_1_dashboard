...
# =========================================================
    ...
    if data and "_insight" in data:
        ...
        # 국내투자는 전체자산에서 해외투자와 현금성자산을 뺀 나머지
