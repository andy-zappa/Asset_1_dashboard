...
# =========================================================
# ⏳ 절세계좌 상세 화면 (Andy님 오더 - 원금/매입금액 분리 연산 교정본)
# =========================================================
    ...
    if isinstance(data, dict):
        # 💡 [교정] 1. 총자산, 투자원금, 매입금액을 각 계좌에서 정확하게 분리하여 합산
        t_asset = 0
        t_principal = 0
        t_buy_total = 0
        ...
        for k in FIXED_ORDER:
            if k in data and isinstance(data[k], dict):
                ...
                # 💡 [교정] 2. 0으로 빠지던 과거 손익 데이터를 계좌별로 직접 합산
