...
# =========================================================
    ...
    if data and "_insight" in data:
        ...
        # 🎯 범례 아이콘 모서리 둥글게(border-radius: 3px) 적용
