...
# =========================================================
# [ Part 1 ] 공통 설정 및 CSS 디자인 (스무스 스크롤 & 테이블 둥글게)
# =========================================================
css = """
<style>
/* 🎯 스무스 스크롤 적용 (부드러운 화면 이동) */
...
/* 🎯 모든 테이블 모서리 둥글게 처리 및 선 겹침 방지 완벽 제어 */
.main-table { 
    width: 100%; 
...
/* 모서리 곡선 바깥으로 테두리 선이 삐져나오지 않도록 마지막 행/열 선 제거 */
...
# =========================================================
    ...
    # 🎯 사이즈 조정 (국내/해외 14px, 현금 12.5px) 및 라벨 위치 영점 조절 완료
