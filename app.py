...
# =========================================================
    ...
    if isinstance(crypto_data, dict) and 'total_asset' in crypto_data:
        ...
        top_box_html = (
            ...
            "<div style='flex: 1.2; display: flex; flex-direction: column; justify-content: center; padding-left: 40px;'>"
            "<div style='text-align:right; margin-bottom:25px;'>"
            f"<div style='font-size: 40px; font-weight: 800; color: #111; line-height: 1.1; letter-spacing: -1px;'>{fmt(c_tot_all)}<span style='font-size: 20px; font-weight: bold; margin-left: 6px; color:#666;'>KRW</span></div>"
            f"<div style='font-size: 18px; font-weight: bold; margin-top: 10px;' class='{col(c_prof)}'>평가손익 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{fmt(c_prof, True)} <span style='font-size:16px;'>({fmt_p(c_rate)})</span></div>"
            "</div>"
            "<div style='border-top: 1px solid #eee; padding-top: 20px; display: flex; flex-direction: column; gap: 12px;'>"
            "<div style='display:flex; justify-content:space-between; align-items:baseline;'><span style='color: #666; font-size: 16px;'>총 매수금액</span><span style='color: #111; font-size: 18px; font-weight: bold;'>" + fmt(c_buy) + "</span></div>"
            "<div style='display:flex; justify-content:space-between; align-items:baseline;'><span style='color: #666; font-size: 16px;'>총 평가금액</span><span style='color: #111; font-size: 18px; font-weight: bold;'>" + fmt(c_eval) + "</span></div>"
            "<div style='display:flex; justify-content:space-between; align-items:baseline;'><span style='color: #666; font-size: 16px;'>주문가능 (KRW)</span><span style='color: #111; font-size: 18px; font-weight: bold;'>" + fmt(c_krw) + "</span></div>"
            "</div></div></div></div>"
        )
        st.markdown(top_box_html, unsafe_allow_html=True)
