...
with st.sidebar:
    ...
    <div id='card-total' class='sidebar-card sidebar-card-dark'>
        ...
        <div style='text-align: right;'>
            ...
            <div style='font-size:15px; margin-top:4px; color:#ff4b4b;'><span class='{col(total_profit)}' style='font-weight:bold;'>{fmt(total_profit, True)}</span> ({fmt_p1(total_rate)})</div>
        </div>
    ...
    <div id='card-crypto' class='sidebar-card'>
        ...
        <div style='text-align: right;'>
            ...
            <div style='font-size:14px; margin-top:4px; color:#555;'><span class='{col(c_prof_sum)}' style='font-weight:bold;'>{fmt(c_prof_sum, True)}</span></div>
