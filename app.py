...
# 11. 🤖 AI 퀀트매매 카드 (우측 정렬 및 오류 방지 완전판)
    ...
    <div id='card-quant' class='sidebar-card' style='display:flex; flex-direction:row; align-items:center; justify-content:flex-start; padding-left: 25px; gap:6px; height: 80px; margin-bottom: 5px; background-color:#ffffff; border:1px solid #eeeeee; border-radius:12px;'>
        ...
        <div style='display:flex; flex-direction:column; align-items:flex-end; align-self:flex-end; margin-bottom:4px; line-height:1.0;'>
            <div style='font-size:20px; font-weight:600; color:#111111; letter-spacing:-1.2px; margin-bottom:3px; text-align:right; width:100%; white-space:nowrap;'>Zappa Quant</div>
